      ...
      topic(
        ...
        [
          ...
          m('g9-engineer-arch', 'engineer', ['Арка моста', 'Көпір аркасы', 'A bridge arch'], [
            {
              story: tx('Профиль арки y = −x² + 4x. Опоры там, где y=0.', 'Арка профилі y = −x² + 4x. Тіректер y=0 жерінде.', 'Arch profile y = −x² + 4x. Supports where y=0.'),
            ...
            {
              story: tx('Высота в середине пролёта (x=2)?', 'Ортадағы биіктік (x=2)?', 'Height at mid-span (x=2)?'),
      ...
      topic(
        ...
        [
          m('g9-photo-shadow', 'photo', ['Тень Байконура', 'Байқоңыр көлеңкесі', 'A Baikonur shadow'], [
            {
              story: tx('Рейка 1.5 м даёт тень 2 м. Башня даёт тень 18 м в тот же час.', '1.5 м рейка 2 м көлеңке береді. Мұнара сол сағатта 18 м көлеңке береді.', 'A 1.5 m rod casts a 2 m shadow. A tower casts 18 m at the same hour.'),
            ...
            {
              story: tx('Если солнце ниже и тень рейки стала 3 м, тень башни?', 'Күн төмендеп рейка көлеңкесі 3 м болса, мұнара көлеңкесі?', 'If the sun is lower and the rod’s shadow is 3 m, the tower’s shadow?'),
          ...
          m('g9-architect-baiterek', 'architect', ['Макет Байтерека', 'Бәйтерек макеті', 'A Baiterek model'], [
            {
              story: tx('Башня 97 м. Макет высотой 0.97 м. Коэффициент подобия?', 'Мұнара 97 м. Макет 0.97 м. Ұқсастық коэффициенті?', 'Tower 97 m. Model 0.97 m. Similarity ratio?'),
            ...
            {
              story: tx('Шар на башне диаметром 22 м. Диаметр шара на макете (м)?', 'Мұнарадағы шар диаметрі 22 м. Макеттегі шар диаметрі (м)?', 'The tower sphere is 22 m across. Model sphere diameter (m)?'),
  ...
  },
  {
    ...
    topics: [
      topic(
        ...
        [
          m('g10-builder-ramp', 'builder', ['Пандус у школы', 'Мектеп пандусы', 'A school ramp'], [
            {
              story: tx('Пандус длиной 5 м поднимается на 1 м. sin α = противолежащий / гипотенуза.', 'Пандус 5 м, 1 м көтереді. sin α = қарсы / гипотенуза.', 'A 5 m ramp rises 1 m. sin α = opposite / hypotenuse.'),
            ...
            {
              story: tx('Горизонтальная проекция: cos α = 4.9/5 при почти пологом пандусе? По Пифагору катет пола √(25−1).', 'Көлденең проекция: Пифагор бойынша еден катеті √(25−1).', 'Horizontal run: by Pythagoras the floor leg is √(25−1).'),
              question: tx('Длина по земле (м), √24 ≈ 4.90', 'Жердегі ұзындық (м), √24 ≈ 4.90', 'Ground length (m), √24 ≈ 4.90'),
              hint: tx('√24 ≈ 4.9', '√24 ≈ 4.9'),
              explain: tx('Строитель размечает длину по двору, не по наклонной доске.', 'Құрылысшы ауладағы ұзындықты еңіс тақтай емес, жермен белгілейді.', 'Builders mark length along the yard, not along the sloping board.'),
              unit: tx('м', 'м', 'm'),
              answer: n(4.9, 0.05),
            },
          ]),
          m('g10-sailor-lighthouse', 'sailor', ['Маяк на Каспии', 'Каспийдегі маяк', 'A Caspian lighthouse'], [
            {
              story: tx('Маяк 40 м. Угол места с палубы 8°, tan 8° ≈ 0.1405. Расстояние d = h / tan α.', 'Маяк 40 м. Палубадан бұрыш 8°, tan 8° ≈ 0.1405. Қашықтық d = h / tan α.', 'Lighthouse 40 m. Elevation 8°, tan 8° ≈ 0.1405. Distance d = h / tan α.'),
            ...
            {
              story: tx('Скорость катера 15 м/с. За сколько секунд дойти, если курс прямой?', 'Катер жылдамдығы 15 м/с. Тіке курспен неше секундта жетеді?', 'Boat speed 15 m/s. Seconds to arrive on a straight course?'),
